...
#ifndef CORE_PARAMETER_PARAMETERCONTAINER_H_
#define CORE_PARAMETER_PARAMETERCONTAINER_H_
...
namespace Core
{
	...
	public:
		 ...
		 * When a shared_ptr is constructed to take over ownership of an object, either vía make_shared or by passing a raw pointer,
...
#endif /* CORE_PARAMETER_PARAMETERCONTAINER_H_ */
