...
#ifndef SOURCE_CORE_PARAMETER_PARAMETER_IDENTIFICATIONGENERATOR_H_
#define SOURCE_CORE_PARAMETER_PARAMETER_IDENTIFICATIONGENERATOR_H_
...
#endif /* SOURCE_CORE_PARAMETER_PARAMETER_IDENTIFICATIONGENERATOR_H_ */
